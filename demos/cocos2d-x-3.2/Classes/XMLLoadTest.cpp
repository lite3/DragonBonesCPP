...
void XMLLoadTest::update(float passTime)
{
...
void XMLLoadTest::armAnimationHandler(cocos2d::EventCustom *event)
{
...
dragonBones::DBCCArmatureNode* XMLLoadTest::createEffect(std::string dragonbones, std::string armature)
{
...
void XMLLoadTest::menuCloseCallback(Ref* pSender)
{
